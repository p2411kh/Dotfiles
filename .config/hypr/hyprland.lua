...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(98971aee)", "rgba(98971aee)"}, angle = 45 },
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(brauser))
...
-- Move active window to ia workspace with mainMod + SHIFT + [0-9]
for i = 1, 10 do
